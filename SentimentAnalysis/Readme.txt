...
3. You should have the training and test data sets.
...
5. The last step will save the test prediction file. Make change to the file name as per your requirement.
